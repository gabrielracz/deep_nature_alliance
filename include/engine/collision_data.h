...
class CollisionData {
   public:
    ...
    const glm::vec3& GetBoxHalfSizes() const { return boxHalfSizes; }
    const glm::vec3& GetRayOrigin() const { return rayOrigin; }
    const glm::vec3& GetRayDirection() const { return rayDirection; }
