...
public:
    ...
    glm::vec3 GetWorldPosition() const {return transf_world_no_scale * glm::vec4(position, 1.0f);}
    const glm::quat& GetOrientation() const { return orientation;}
    glm::quat GetWorldOrientation() const {return transf_world_no_scale * glm::mat4_cast(orientation);}
